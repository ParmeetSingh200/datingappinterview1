...
import 'package:gaydatingapp/slider.dart';
import 'package:gaydatingapp/splash_screen.dart';
    ...
    return MaterialApp(
      ...
      theme: Theme.of(context).copyWith(
        colorScheme: Theme.of(context).colorScheme.copyWith(
          primary: const Color(0xffdd3953),
        ),
      ),
      home: WelcomeScreen(),
    );
...
class MyHomePage extends StatefulWidget {
  ...
  // This class is the configuration for the state. It h  olds the values (in this
